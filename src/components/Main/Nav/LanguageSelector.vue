<template>
  <div ref="dropdownRef" :class="themeClass" class="relative inline-block">
    ...
    <button @click="toggleDropdown"
      ...
      <!-- Dropdown Arrow -->
      <svg class="w-4 h-4 ml-2 transition-transform" :class="{ 'rotate-180': isDropdownOpen }"
    ...
    <div v-if="isDropdownOpen"
      ...
      <div v-for="lang in languages" :key="lang.code"
        ...
        <div
          class="flex items-center p-3 w-full space-x-3 rounded-md hover:bg-gray-700 hover:text-gray-200 transition-all">
