    ...
    <div :class="formClass" class="relative w-full p-2 sm:p-12 rounded-2xl lg:rounded-3xl shadow-xl">
      ...
      <form @submit.prevent="submitForm" class="space-y-8">
        <div class="flex space-x-6">
          <div class="w-1/2">
              <label for="company" :class="labelClass" class="block text-sm font-medium">Company</label>
          ...
          <div class="w-1/2">
              <label for="subscription-type" :class="labelClass" class="block text-sm font-medium">Subscription Type</label>
        ...
        <div class="flex space-x-6">
          <div class="w-1/2">
            <label for="start-date" :class="labelClass" class="block text-sm font-medium">Start Date</label>
            <input
              type="date"
              id="start-date"
          ...
          <div class="w-1/2">
            <label for="start-date" :class="labelClass" class="block text-sm font-medium">End Date</label>
            <input
              type="date"
              id="end-date"
              v-model="formData.startDate"
        ...
        <div class="flex justify-between items-center space-x-6">
          <div class="flex items-center space-x-4 w-1/2">
            <label for="active-status" :class="labelClass" class="text-sm font-medium">Active Status</label>
          ...
          <div class="flex items-center space-x-4 w-1/2">
            <label for="subscription-status" :class="labelClass" class="text-sm font-medium">Subscription Status</label>
